...
int main() {
	...
	if (inputSelection == 1) {
		...
		ifstream inputFile;
		inputFile.open(path + "RawTaglist.csv");
		if (inputFile.is_open()) {
			...
			outputEdgeFile.open(path + "EdgeList.csv");
			...
			outputIntToTag.open(path +"IntToTagTranslator.csv");
			...
			outputIntToTitle.open(path + "IntToTitleTranslator.csv");
	...
	if (inputSelection == 2) {
		...
		ifstream inputFile;
		inputFile.open(path + "EdgeList.csv");

		ofstream outputFile;
		outputFile.open(path + "ReducedEdgeList.csv");
	...
	if (inputSelection == 3) {
		...
		if (inputSelection == 2) {
			inputFile.open(path + "ReducedEdgeList.csv");
		}
